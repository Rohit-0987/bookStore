        ...
        <div className='max-w--screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
            <div className='w-full md:w-1/2  mt-12 md:mt-32 order-2 md:order-1'>
                <div className='space-y-12'>
                    <h1 className='text-4xl font-bold'>Hello, welcome here to learn something new <span className='text-pink-500'>everyday !!! </span></h1>
            ...
            <div className='w-full md:w-1/2  mt-12 md:mt-32 order-1'>
                <img src={banner} className='w-96 h-96 ml-20' alt="" />
            </div>
        </div>
    </>
  )
